...
<TypeTable
  type={{
    ...
    credentials: {
      description:
        'Credentials mode for the fetch request to your server when requesting pre-signed URLs. Use "include" to send cookies with cross-origin requests.',
      type: 'RequestCredentials',
      typeDescription: 'Can be "include", "same-origin", or "omit".',
      required: false,
    },
    retry: {
