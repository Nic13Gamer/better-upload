...
Better Upload can work in any framework with API routes that use Request and Response objects. You can even use it in a separate backend server, like [Hono](https://hono.dev) or [Express](https://expressjs.com).
