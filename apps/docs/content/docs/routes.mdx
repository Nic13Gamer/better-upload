...
If you want to upload files larger than 5GB, you need to use multipart uploads. To enable it, set `multipart` to `true`. It works both for single and multiple files.
